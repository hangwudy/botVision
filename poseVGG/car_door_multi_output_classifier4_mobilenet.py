...
ap.add_argument("-d", "--dataset", 
	default="/media/hangwu/TOSHIBA_EXT/Dataset/renderings_square_half",
	# required=True,
	help="path to input dataset (i.e., directory of images)")
ap.add_argument("-m", "--model", 
	default="output/pose_mobilenet.h5",
	# required=True,
	help="path to output model")
ap.add_argument("-l", "--label", 
	default="/media/hangwu/TOSHIBA_EXT/Dataset/annotations/pose/car_door_attitude_half.json",
	# required=True, 
...
model = PoseNet.MobileNet_mod(224,224,
...
with open('history_mobilenet.json', 'w') as outfile:
...
plt.tight_layout()
plt.savefig("{}_losses_mobilenet.pdf".format(args["plot"]))
plt.close()
...
plt.tight_layout()
plt.savefig("{}_accs_mobilenet.pdf".format(args["plot"]))
plt.close()
